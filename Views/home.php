 ...
 ?>
				...
				<div class="item-slick1" style="background-image: url(<?= $arrSlider[$i]['portada'] ?>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="600">
								<h2 class="ltext-201 cl0 p-t-19 p-b-13 respon1">
									<?= $arrSlider[$i]['nombre'] ?>
								</h2>
							</div>
							<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="1200">
								<span class="ltext-101 cl0 p-b-13 respon1">
	...
	<section class="bg0 p-t-23 p-b-140" >
		<div class="container">
			...
			<hr>
			<div class="row isotope-grid" ali>
			<?php 
