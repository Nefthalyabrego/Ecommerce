		...
		<div class="container">
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				...
				<?php if($data['pagina'] != $data['total_paginas']) { ?>
					<a href="<?= base_url()?>/tienda/search?p=<?= $nextPagina.'&s'.$data['busqueda'] ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04"></i>Siguiente &nbsp; <i class="fas fa-chevron-right"></i></a>
				<?php } ?>
			</div>
		</div>
	</div>
