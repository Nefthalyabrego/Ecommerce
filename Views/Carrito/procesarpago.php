				...
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-22">
							<label for="start">Agendar para:</label>
							<input type="date" id="start" name="trip-start" value="2021-07-14" min="2021-07-15" max="2021-08-15"><input type="time" id="start" name="trip-start" value="06:00" min="6:00" max="21:00">
							</div>
						</div>
					<?php }else{ ?>
